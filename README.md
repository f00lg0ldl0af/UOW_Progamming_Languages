# Overview
UOW: Programming Languages Part A

# Description 

This [course](https://www.coursera.org/learn/programming-languages/home/welcome) is an introduction to the basic concepts of programming languages, with a strong emphasis on functional programming. The course uses the languages ML (in Part A), Racket (in Part B), and Ruby (in Part C) as vehicles for teaching the concepts, but the real intent is to teach enough about how any language “fits together” to make you more effective programming in any language -- and in learning new ones. 

In part A of the course, download the [SML/NJ compiler](https://www.smlnj.org/dist/working/110.80/110.80-README.html) and [Emacs](https://www.gnu.org/software/emacs/) to read the code.
