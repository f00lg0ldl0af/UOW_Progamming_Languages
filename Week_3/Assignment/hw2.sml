...
(* should not end the game simply because the card list is empty. There might still be Discard. Discard moves left for example. The game ends on a Draw
Draw move from an empty card list. *)
